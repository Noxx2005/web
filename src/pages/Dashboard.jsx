...
function Dashboard() {
  const { data: stats, isLoading } = useQuery('dashboard-stats', async () => {
    // Fetch profiles to get basic stats
  ...
  return (
    <div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Quick Access</dt>
      ...
      <div className="mt-8 bg-white shadow rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Welcome to Insighta Labs+</h2>
        <p className="text-gray-600">
          Use the navigation menu to browse profiles, search using natural language queries, 
